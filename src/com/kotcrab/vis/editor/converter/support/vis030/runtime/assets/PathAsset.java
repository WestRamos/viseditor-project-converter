...
public abstract class PathAsset implements VisAssetDescriptor {
	...
	public boolean compare (VisAssetDescriptor asset) {
		if (asset instanceof com.kotcrab.vis.runtime.assets.PathAsset == false) return false;
		return relativePath.equals(((com.kotcrab.vis.runtime.assets.PathAsset) asset).getPath());
	}
}
